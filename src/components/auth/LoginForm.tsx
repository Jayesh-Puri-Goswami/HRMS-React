    ...
    <div className="flex flex-col flex-1 min-h-screen transition-colors duration-500">
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 dark:from-gray-900 dark:via-gray-800 dark:to-purple-900 flex items-center justify-center p-4 relative overflow-hidden">
        ...
        >
          ...
          >
            {/* Logo */}
            <motion.div variants={logoVariants as any} className="block md:hidden flex justify-center mb-8">
              <div className="relative w-20 h-20 sm:w-24 sm:h-24">
                <img src="/images/logo/CSL-Monogram.svg" alt="CSL Logo" className="object-contain w-full h-full" />
              </div>
            </motion.div>
            ...
            <form onSubmit={handleLogin} className="space-y-6">
              ...
              <motion.div variants={itemVariants as any}>
                ...
                <div className="relative">
                  <motion.div
                    className={`absolute left-3 top-1/2 transform -translate-y-1/2 transition-colors duration-200 ${focusedField === "email" ? "text-purple-500" : "text-gray-400"
                      }`}
                  >
              ...
              <motion.div variants={itemVariants as any}>
                ...
                <div className="relative">
                  <motion.div
                    className={`absolute left-3 top-1/2 transform -translate-y-1/2 transition-colors duration-200 ${focusedField === "password" ? "text-purple-500" : "text-gray-400"
                      }`}
                  >
