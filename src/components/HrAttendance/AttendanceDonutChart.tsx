...
const AttendanceDonutChart: React.FC<AttendanceDonutChartProps> = ({
  labels,
  series,
  title ,
  ...
  return (
    <div
      className={`w-full py-5 max-w-md mx-auto bg-transparent dark:bg-transparent border-none shadow-none dark:shadow-none flex  flex-col `}
    >
      <div
