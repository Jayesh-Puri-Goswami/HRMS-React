...
function StatsCard({ value,label,className,labelClassName,valueClassName,boxClassName }: StatsCardProps) {
  return (
    <>
      <Card className={clsx("bg-themeBackgroundColor dark:bg-white/[0.2] border-0 shadow-sm rounded-xl w-[317px] h-[88px] flex justify-center items-center", className, boxClassName)}>
